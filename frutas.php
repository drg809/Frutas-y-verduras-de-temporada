...
$cad = "SELECT id, nombre, icono, month(inicio), month(final) FROM frutas where ( MONTH(inicio) >= MONTH(final)  and ( MONTH(CURDATE()) >= MONTH(inicio) or MONTH(CURDATE()) <= MONTH(final) )) or (MONTH(inicio) <= MONTH(final) and MONTH(CURDATE()) >= MONTH(inicio) and MONTH(CURDATE()) <= MONTH(final))";
...
<tr><td class="cabecera" style="width:100px; text-align:center;">Nombre</td><td  class="cabecera" style="width:200px; text-align:center;">Imagen</td><td  class="cabecera" style="width:200px; text-align:center;">Mes Inicio</td><td  class="cabecera" style="width:200px; text-align:center;">Mes Final</td></tr><tr>
